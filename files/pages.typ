...
#let apply-header-footer(doc, short-title: none) = {
  set page(header: { 
    grid(columns: (1fr, 1fr),
      align(horizon, smallcaps(text(fill: rgb("5f259f"), size: 14pt, font: "New Computer Modern", weight: "regular")[#short-title])),
      align(right, image("./../assets/logomiones_black.png", height: 15mm)))
  }, numbering: "1 / 1")
...
=== You get real bored
oui oui baguette #footnote[because baguette] 
